...
export default class BDEmoteHuge extends BDV2.reactComponent {
    constructor(props) {
        super(props);
            ...
            (childProps) => {
                return BDV2.react.createElement("div", Object.assign({
                    ...
                    BDV2.react.createElement("img", {
                        draggable: false,
                        className: "emote-huge" + this.modifierClass + (this.props.jumboable ? " jumboable" : "") + (!this.state.shouldAnimate ? " stop-animation" : ""),
                        ...
                        onClick: (e) => {
                            e.preventDefault();
                            e.stopPropagation();
                            require('electron').shell.openExternal("https://docs.google.com/presentation/d/1lcRcs-1PVVep0e5rTR7PD9q0IaShZ4gjxRtmaEPhjmg/present?slide=id.ga0b8216569_0_104");
                        }
                    }),
